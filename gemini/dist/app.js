...
app.post('/gemini', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const genAI = new generative_ai_1.GoogleGenerativeAI(process.env.GEMINI_API_KEY);
        const model = genAI.getGenerativeModel({ model: "gemini-2.0-flash" });
        let formattedChat = formatChat(req.body.chatHistory);
        formattedChat += `User: ${req.body.prompt}`;
        const result = yield model.generateContent(formattedChat);
        res.status(200).json({
...
const formatChat = (chat) => {
    var _a, _b;
    if (!Array.isArray(chat) || chat.length === 0 || !((_a = chat[0]) === null || _a === void 0 ? void 0 : _a.prompts) || !((_b = chat[0]) === null || _b === void 0 ? void 0 : _b.responses)) {
        return '';
    }
    let formattedChat = '';
